<?php
	...
	if(isset($_POST['Edit']))
	{
		...
		if($dept != 'JHS' && $dept != 'SHS' && $dept != 'COL')
		{
			...
			window.location='sched_sat.php';</script>";
		}
		else
		{
		...
		<div class="container">
			<section class="section-content py-3">
				<div class="row">
					...
					<main class="col-lg-9">
						<h5>Computer Laboratory Saturday Schedule/s</h5>
						<div class="tab">
						...
						<div id="CL1" class="tabcontent">
							<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
								...
								<?php
								$get = "SELECT * FROM tbl_lab WHERE Lab = 'CL1' AND Day = 'Sat' ORDER BY Start_Time ASC";
							...
							<?php if($type == 'labcoordinator' || $type == 'admin'){ ?>
								...
								<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
									...
									<?php
									$get = "SELECT * FROM tbl_lab_pending WHERE Lab = 'CL1' AND Day = 'Sat' AND Flag = 'true' ORDER BY Start_Time ASC";
									$get_run = mysqli_query($connect, $get);
									while($row = mysqli_fetch_row($get_run)){
										$pendingno = "$row[0]";
										$empno = "$row[1]";
						...
						<div id="CL2" class="tabcontent">
							<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
								...
								<?php
								$get = "SELECT * FROM tbl_lab WHERE Lab = 'CL2' AND Day = 'Sat' ORDER BY Start_Time ASC";
								$get_run = mysqli_query($connect, $get);
								while($row = mysqli_fetch_row($get_run)){
									$empno = "$row[0]";
									$empname = "$row[1]";
							...
							<?php if($type == 'labcoordinator' || $type == 'admin'){ ?>
								...
								<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
									...
									<?php
									$get = "SELECT * FROM tbl_lab_pending WHERE Lab = 'CL2' AND Day = 'Sat' AND Flag = 'true' ORDER BY Start_Time ASC";
									$get_run = mysqli_query($connect, $get);
									while($row = mysqli_fetch_row($get_run)){
										$pendingno = "$row[0]";
										$empno = "$row[1]";
						...
						<div id="CL3" class="tabcontent">
							<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
								...
								<?php
								$get = "SELECT * FROM tbl_lab WHERE Lab = 'CL3' AND Day = 'Sat' ORDER BY Start_Time ASC";
								$get_run = mysqli_query($connect, $get);
								while($row = mysqli_fetch_row($get_run)){
									$empno = "$row[0]";
									$empname = "$row[1]";
							...
							<?php if($type == 'labcoordinator' || $type == 'admin'){ ?>
								...
								<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
									...
									<?php
									$get = "SELECT * FROM tbl_lab_pending WHERE Lab = 'CL3' AND Day = 'Sat' AND Flag = 'true' ORDER BY Start_Time ASC";
									$get_run = mysqli_query($connect, $get);
									while($row = mysqli_fetch_row($get_run)){
										$pendingno = "$row[0]";
										$empno = "$row[1]";
						...
						<div id="CL4" class="tabcontent">
							<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
								...
								<?php
								$get = "SELECT * FROM tbl_lab WHERE Lab = 'CL4' AND Day = 'Sat' ORDER BY Start_Time ASC";
								$get_run = mysqli_query($connect, $get);
								while($row = mysqli_fetch_row($get_run)){
									$empno = "$row[0]";
									$empname = "$row[1]";
							...
							<?php if($type == 'labcoordinator' || $type == 'admin'){ ?>
								...
								<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
									...
									<?php
									$get = "SELECT * FROM tbl_lab_pending WHERE Lab = 'CL4' AND Day = 'Sat' AND Flag = 'true' ORDER BY Start_Time ASC";
									$get_run = mysqli_query($connect, $get);
									while($row = mysqli_fetch_row($get_run)){
										$pendingno = "$row[0]";
										$empno = "$row[1]";
						...
						<div id="CSS" class="tabcontent">
							<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
								...
								<?php
								$get = "SELECT * FROM tbl_lab WHERE Lab = 'CSS' AND Day = 'Sat' ORDER BY Start_Time ASC";
								$get_run = mysqli_query($connect, $get);
								while($row = mysqli_fetch_row($get_run)){
									$empno = "$row[0]";
									$empname = "$row[1]";
							...
							<?php if($type == 'labcoordinator' || $type == 'admin'){ ?>
								...
								<table id = 'myUL' class = 'table table-striped tables' style='background-color:white; margin-left: -10px; margin-top: -10px;'>
									...
									<?php
									$get = "SELECT * FROM tbl_lab_pending WHERE Lab = 'CSS' AND Day = 'Sat' AND Flag = 'true' ORDER BY Start_Time ASC";
									$get_run = mysqli_query($connect, $get);
									while($row = mysqli_fetch_row($get_run)){
										$pendingno = "$row[0]";
										$empno = "$row[1]";
